...
import info.allywingz.com.consumerpowersaver.Adapter.DBTotalAdapter;
import info.allywingz.com.consumerpowersaver.Adapter.NewAppliancesAdapter;
...
public class Appliances extends Fragment implements View.OnClickListener{
    ...
    RecyclerView recyclerView, total_recyclerview;
    TextView no_appliance ;
    private RecyclerView.LayoutManager layoutManager;
    DBAdapter mDBAdapter ;
    NewAppliancesAdapter mNewDBAdapter ;
    ...
    public static TextView grand_total_txt, avge_total  ;
    TextView fab ;
    ...
    TextView item_name, maker, power, time, total_units, display_total ;
    LinearLayout complete_layout, suggestions_layout ;
            ...
            case R.id.fab :
                ...
                if (input_item_name.getText().toString().trim().length()==0){
                    ...
                    AddItemsLayout(input_item_name.getText().toString().trim(),
                            Utility.checkNull(input_item_maker.getText().toString().trim()),
    ...
    public static void setAlertDialog(final Context context, final String item_name) {
        ...
        alertbox.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        DBHelper ddd = new DBHelper(context);
                        SQLiteDatabase db = ddd.getWritableDatabase();
                        db.delete(DBHelper.TABLE_NAME, DBHelper.ITEM_NAME + "=\""
                                + item_name + "\"", null);
                        Utility.showToast(context, "Deleted Record Successfully");
                    }
                });
        alertbox.show();
    }
