...
public class Registration extends AppCompatActivity {
    ...
    String userChoosenTask, imageString="" ;
    ...
    private void submitForm() {
        if (!validateName()) {
            ...
            inputLayoutPassword.setError("Password length should not be less than 6");
            ...
            user.setUsername(inputmobile.getText().toString().trim());
            ...
            user.put("MobileNo", inputmobile.getText().toString().trim());
            user.put("FirstName", inputName.getText().toString().trim());
            user.put("LastName", inputlastName.getText().toString().trim());
            user.put("UserPassword", inputPassword.getText().toString().trim());
            ...
            user.signUpInBackground(new SignUpCallback() {
                public void done(ParseException e) {
                    ...
                    if (e == null) {
                        ...
                        Utility.showToast(Registration.this, e.getMessage());
                    }
                }
            });
        }
